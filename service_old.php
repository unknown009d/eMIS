...
// Selecting all the nom types
// $query = "SELECT DISTINCT nom,t_charge FROM `tbl_nom` ORDER BY nom ASC";
// $query = "SELECT DISTINCT sr_no, nom, t_charge FROM tbl_nom WHERE SUBSTRING_INDEX(sr_no, '/', 1) = '" . $page . "' ORDER BY nom ASC";
// $query = "SELECT DISTINCT nom_name FROM tbl_new_nom WHERE j_type='" . $page . "' ORDER BY id DESC";
// $result = mysqli_query($conn, $query);
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              <label for="srqno" class="form-label">
                SRQ No.
                <span class="text-success toosmall" style="cursor: help;" title="<?php
                echo $latestEntry[0]['c_name'] . " | " . $latestEntry[0]['c_phn'] . " | " . $latestEntry[0]['sr_date'];
                ?>">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="date" onchange="getsrqno()">
            </div>
          </div>
          <div class="col">
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" id="onsiteValue" class="form-control" oninput="onsiteChange(this)"
                  onblur="calculateGST()">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" list="clients" autocomplete="off"
                onblur="fillTheForm(this.value);" id="name" placeholder="eg. Jhon Doe" required>
              <?php
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" placeholder="eg. jhondoe@mail.com" readonly
                tabindex="-1">
            </div>
          </div>
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="address" placeholder="eg. Indranagar, Agartala" readonly
                tabindex="-1">
            </div>
          </div>
          <div class="col">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="gstno" placeholder="eg. 0717USA12345NF1" readonly
                tabindex="-1">
            </div>
          </div>
        </div>
          ...
          <div class="row row-item">
            <div class="col-3">
              <div class="mb-3">
                ...
                <?php
                // echo "<datalist id='nom'>";
                // foreach ($nom as $data) {
                //   echo "<option value='" . $data["nom_name"] . "'> " . $data["nom_name"] . " </option>";
                // }
                // echo "</datalist>";
                ?>
              </div>
            ...
            <div class="col">
              <div class="mb-3">
                <input type="number" class="form-control rate"
                  oninput="addTotalNom(this.parentNode.parentNode.parentNode)" min="0" placeholder="" readonly
                  tabindex="-1">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
                <input type="number" class="form-control quantity"
                  oninput="addTotalNom(this.parentNode.parentNode.parentNode)" min="0" max="1000" placeholder="">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
            ...
            <div class="col-1">
              <button type="button" class="btn btn-danger removeRow" onclick="removeRow(this.parentNode.parentNode)"><i
          ...
          <div id="swTextbox" class="col" style="display: none;">
            <div class="row">
              <div class="col">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="swSharedTxt" placeholder="eg. 50">
                  <span class="input-group-text">%</span>
                </div>
              </div>
              <div class="col">
...
<div class="modal fade" id="createPP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  aria-labelledby="createPPLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
          onclick="submitSuccessfully();">Skip</button>
...
<script>
  ...
  const getNoms = async () => {
    await fetch("api/nom_list.php", {
      ...
      if (data.success = true) {
        $('nomlist').innerHTML = '';
        data.data.forEach(d => {
          $('nomlist').innerHTML += `<option value="${d.id}">${d.nom}</option>`;
        })
      } else {
  ...
  const calculateGST = () => {
    ...
    /* This is updating the amount single-window under Miscellaneous */
    document.getElementById("swAmountTxt").value = totalCharge;
  };
  ...
  document.getElementById("service-request-form").addEventListener("submit", (e) => {
    ...
    fetch("api/service_req.php", {
      ...
      .then(data => {
        ...
        if (data.success) {
          ...
          <?php if ($page == 'IT'): ?>
            ...
            let output = `<p class='text-muted small'>Select the nomenclatures to create a new project</p>
            ...
            <tr onclick="toggleCheckbox(this)">
              <td>
                <input class="form-check-input" type="checkbox" 
                  value="${$('srqno').value.replace(/[\/-]/g, '')}${(cnt + 1).toString().padStart(3, '0')}" 
                  id="rd${cnt}" 
                  ${d.nomenclature.toLowerCase().includes("gigw") ? "checked" : ""}>
              </td>
              <td>
                ${$('srqno').value.replace(/[\/-]/g, '')}${(cnt + 1).toString().padStart(3, '0')}
              </td>
              <td>
                ${d.nomenclature}
              </td>
      ...
      <?php if ($page == 'IT'): ?>
        ...
        const createPPForm = new bootstrap.Modal(document.getElementById('createPP')); createPPForm.show();
      <?php endif; ?>
  });
